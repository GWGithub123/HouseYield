...
<table>
  ...
  <tr>
    <td><img src="docs/properties-charts.png" alt="Tax, return, mortgage, NOI, equity, and total-return charts" /></td>
    <td><img src="docs/neighborhood-flood.png" alt="Neighborhood flood simulation and drainage corridors" /></td>
  </tr>
  <tr>
    <td><img src="docs/documents-esign.png" alt="Leases, uploads, and pending e-signatures" /></td>
  ...
  <tr>
    <td><img src="docs/dispatch.png" alt="AI maintenance dispatch workflow" /></td>
